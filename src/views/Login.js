...
const Login = (props) => {
  ...
  const fmsLogo = '@src/assets/images/logo/logo.jpeg'
  const cp1 = '@src/assets/images/pages/Logo_develoPPP_claim_RGB.png'
  const cp2 = '@src/assets/images/pages/GIZ-Combined-logo-scaled.jpg'
  const cp3 = '@src/assets/images/pages/transerve.png'
  const emp = '@src/assets/images/pages/employee_new.png'
  const citizen_logo = '@src/assets/images/pages/citizen_new.png'
  const defaultValues = {
    email: "",
    password: ""
  }
    ...
    <div >
      <Row>
        ...
        <Col className='d-flex align-items-center pr-1' lg='7' sm='12' md="12" style={{ margin: "11% 0 0 0" }}>
          {/* <Card className='d-flex align-items-center' style={{ margin: "18% 0 0 0" }}> */}
          {/* <CardBody  > */}
          {/* <Swiper dir={isRtl ? 'rtl' : 'ltr'} {...params}> */}
          {/* <SwiperSlide>
                  <img src={img1} alt='swiper 1' style={{ overflow: "hidden", width: "100%", height: "380px" }} />
                </SwiperSlide>
                <SwiperSlide>
                  <img src={img2} alt='swiper 2' style={{ overflow: "hidden", width: "100%", height: "380px" }} />
                </SwiperSlide>
                <SwiperSlide>
                  <img src={img3} alt='swiper 3' style={{ overflow: "hidden", width: "100%", height: "380px" }} />
                </SwiperSlide> */}
          {/* <SwiperSlide> */}
